"use strict";
/* CAGE LEGACY — state/state-faith.js
   Domaine Faith : records de carrières scellées (meta.faithLegends,
   state-analytics.js pour loadMetaStats/saveMetaStats), registre de
   personnes (G.people : coach/agent/directeur/journaliste/sparring),
   sélection de salle d'entraînement et de coach. */
...
/* ==== [FIN ANCRE] ==== */
/* migrateGauntletBest, gauntletAscLevel, gauntletBestGet, GAUNTLET_ASC_UNLOCK, gauntletAscUnlockGoal, gauntletAscUnlockReached,
   recordGauntletAscension, nextObjective, recordGauntletBest, GAUNTLET_ASC_MAX, gauntletBestByArchetypeGet, recordGauntletBestByArchetype,
   gauntletGhostLogGet, recordGauntletGhostLog, GAUNTLET_CONSUMABLES, purchaseGauntletConsumable, applyPendingGauntletConsumable, gauntletDevilCost :
   déplacés vers state/state-gauntlet.js. */
