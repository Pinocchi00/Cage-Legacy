...
| `docs/LOT-2B-LE-VIVIER-SE-RENOUVELLE.md` | **Lot 2B — contrat écrit le 21/09. T1 livrée** (branche `lot-2b-t1-monde-exterieur`, non fusionnée) ; T2 à T4 non commencées. Répond à QO-8. Son §5 liste les cinq points tranchés avant la T2, son §5 d la relecture de la T1, son **§5 e la décision du 22/09 : le monde extérieur dérivé prend un écran au lot 4** — les quatre noms de `MGMT_EXT_ORGS` (`[EMPLACEMENT AUTEUR]`) sont donc dus au lot 4, pas à la T2 |
