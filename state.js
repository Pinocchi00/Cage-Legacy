...
/* CAGE LEGACY — state.js (en cours d'extraction vers state/*.js)
   Panthéon persistant, migration, validation. G/esc/setTheme sont dans
   state/state-core.js ; meta-stats/analytics dans state/state-analytics.js ;
   save/load/hasSave/wipe/parseAndValidate/SAVE_KEY/SAVE_BACKUP_KEY dans
   state/state-save.js (tous chargés avant ce fichier). */
...
/* ==== [FIN ANCRE] ==== */
/* ==== [FIN ANCRE] ==== */
/* migrate() et SAVE_VERSION : déplacés vers state/state-migration.js. */
